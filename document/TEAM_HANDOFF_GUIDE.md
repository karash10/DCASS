...
- `scripts/run_sender.py` (383 lines)
- `scripts/run_receiver.py` (296 lines)
...
#### File: `scripts/run_receiver.py` (lines 224-235)
...
6. `scripts/run_sender.py` - Alice's implementation

7. `scripts/run_receiver.py` - Bob's implementation

**Run These Demos:**
```bash
python scripts/demo_dcass.py          # Full system demo
python scripts/demo_encoder.py        # Encoding only
python scripts/test_encoding.py       # Test suite
python scripts/test_stealth_system.py # Stealth testing
```
...
python scripts/download_wikipedia.py --num-articles 5000

# Build indices (30 minutes)
python scripts/build_indices.py

# Generate training data (5 minutes)
python scripts/generate_traffic_data.py --num-sessions 2000

# Train GAN (2-4 hours)
python scripts/train_gan.py --epochs 50

# Train RL (4-8 hours)
python scripts/train_rl.py --episodes 1000 --warden-checkpoint models/gan/final.pt

# Test with trained models
python scripts/demo_dcass.py --mode rl --rl-checkpoint models/rl/ppo_agent_final.pt
```
...
[ ] Encoding works: python scripts/demo_encoder.py
[ ] Decoding works: python scripts/test_encoding.py
[ ] Full loop works: python scripts/demo_full_loop.py
...
# 3. API
[ ] Server starts: python scripts/start_server.py
...
**Training Files:**
5. `scripts/train_gan.py`
6. `scripts/train_rl.py`
7. `scripts/generate_traffic_data.py`

**Docker Files:**
8. `Dockerfile`
9. `docker-compose.yml`
10. `scripts/run_sender.py`
11. `scripts/run_receiver.py`
...
5. **Rebuild indices** - `python scripts/build_indices.py`
