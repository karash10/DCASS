...
|--------|------|---------|-------|
| Sender | `scripts/run_sender.py` | Alice's transmission logic | 383 |
| Receiver | `scripts/run_receiver.py` | Bob's reassembly logic | 296 |
| Orchestrator | `scripts/docker_orchestrate.py` | Container management | 136 |
